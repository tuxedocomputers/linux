...
awk --include inplace '{count+=gsub("^ bindgen \\[amd64 arm64 armhf ppc64el riscv64 s390x\\],$"," bindgen-0.56 [amd64 arm64 armhf ppc64el riscv64 s390x],");print}END{if(count!=1)exit 1}'  debian.${TUXEDO_KERNEL_BRANCH}/control.stub.in
