...
do-binary-udebs: linux_udeb_name=$(shell if echo $(src_pkg_name)|egrep -q '(linux-unstable|linux-lts|linux-hwe|linux-tuxedo|linux-[0-9]+\.[0-9]+)'; then echo $(src_pkg_name); else echo linux; fi)
