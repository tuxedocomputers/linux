...
#define UNIWILL_FEATURE_USB_C_POWER_PRIORITY	BIT(7)
#define UNIWILL_FEATURE_CHARGING_PROFILE	BIT(8)
#define UNIWILL_FEATURE_USB_C_POWERSHARE	BIT(9)

#define UNIWILL_FEATURE_FAN_CTRL		BIT(10)
#define FAN_CTRL_TYPE_OFFSET			11
#define UNIWILL_FEATURE_FAN_CTRL_TYPE_MASK	(GENMASK(1, 0) << FAN_CTRL_TYPE_OFFSET)
#define FAN_CTRL_TYPE_UNIVERSAL			(0 << FAN_CTRL_TYPE_OFFSET)
#define FAN_CTRL_TYPE_UNIVERSAL_CUSTOM_PROFILE	(1 << FAN_CTRL_TYPE_OFFSET)
#define FAN_CTRL_TYPE_FAN_BOOST_MODE_HACK	(2 << FAN_CTRL_TYPE_OFFSET)
#define FAN_CTRL_TYPE_RESERVED			(3 << FAN_CTRL_TYPE_OFFSET)

#define UNIWILL_FEATURE_TDP_CONTROL		BIT(13)
#define TDP_CONTROL_TYPE_OFFSET			14
#define UNIWILL_FEATURE_TDP_CONTROL_TYPE_MASK	(GENMASK(1, 0) << TDP_CONTROL_TYPE_OFFSET)
#define TDP_CONTROL_TYPE_DEFAULT		(0 << TDP_CONTROL_TYPE_OFFSET)
#define TDP_CONTROL_TYPE_DEFAULT_DOUBLE_PL4	(1 << TDP_CONTROL_TYPE_OFFSET)
#define TDP_CONTROL_TYPE_RESERVED_1		(2 << TDP_CONTROL_TYPE_OFFSET)
#define TDP_CONTROL_TYPE_RESERVED_2		(3 << TDP_CONTROL_TYPE_OFFSET)

#define UNIWILL_FEATURE_KBD_BACKLIGHT		BIT(16)
#define KBD_BACKLIGHT_TYPE_OFFSET		17
#define UNIWILL_FEATURE_KBD_BACKLIGHT_TYPE_MASK	(GENMASK(1, 0) << KBD_BACKLIGHT_TYPE_OFFSET)
#define KBD_BACKLIGHT_TYPE_WHITE_3_STEPS	(0 << KBD_BACKLIGHT_TYPE_OFFSET)
#define KBD_BACKLIGHT_TYPE_WHITE_5_STEPS	(1 << KBD_BACKLIGHT_TYPE_OFFSET)
#define KBD_BACKLIGHT_TYPE_1_ZONE_RGB		(2 << KBD_BACKLIGHT_TYPE_OFFSET)
#define KBD_BACKLIGHT_TYPE_RESERVED		(3 << KBD_BACKLIGHT_TYPE_OFFSET)

#define UNIWILL_FEATURE_POWER_PROFILE		BIT(19)
#define POWER_PROFILE_TYPE_OFFSET		20
#define UNIWILL_FEATURE_POWER_PROFILE_TYPE_MASK (GENMASK(1, 0) << POWER_PROFILE_TYPE_OFFSET)
#define POWER_PROFILE_TYPE_2_PROFILES		(0 << POWER_PROFILE_TYPE_OFFSET)
#define POWER_PROFILE_TYPE_3_PROFILES		(1 << POWER_PROFILE_TYPE_OFFSET)
#define POWER_PROFILE_TYPE_3_PROFILES_LED_ONLY	(2 << POWER_PROFILE_TYPE_OFFSET)
#define POWER_PROFILE_TYPE_RESERVED		(3 << POWER_PROFILE_TYPE_OFFSET)
>>>>>>> e09429f1d3089 (platform/x86/uniwill: Add more feature defines)
...
static struct uniwill_device_descriptor phxarx1_phxaqf1_descriptor __initdata = {
	.features = UNIWILL_FEATURE_USB_C_POWER_PRIORITY,
